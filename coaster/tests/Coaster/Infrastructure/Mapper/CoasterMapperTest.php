...
final class CoasterMapperTest extends TestCase
{
    ...
    {
        $json = '{"id":"b22f1078-e38a-43bf-a3e6-391d3dfc8a77","availablePersonnel":1,"clientsPerDay":2,"trackLengthInMeters":3,"from":"2020-01-01T08:00:00+00:00","to":"2020-01-01T16:00:00+00:00"}';
        ...
        $this->assertSame("2020-01-01T08:00:00+00:00", $entity->timeRange->from->format(DateTimeInterface::ATOM));
        $this->assertSame("2020-01-01T16:00:00+00:00", $entity->timeRange->to->format(DateTimeInterface::ATOM));
    }
    ...
    public function testToJSON(): void
    {
        ...
        $this->assertSame(
            '{"id":"b22f1078-e38a-43bf-a3e6-391d3dfc8a77","availablePersonnel":1,"clientsPerDay":2,"trackLengthInMeters":3,"from":"2000-01-01T08:00:00+00:00","to":"2000-01-01T16:00:00+00:00"}',
